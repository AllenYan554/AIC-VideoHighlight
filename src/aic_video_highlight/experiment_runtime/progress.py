...
class ProgressReporter:
    ...
    def update(self, processed: int, *, current_video: str | None = None, current_shard: str | None = None, errors: int = 0, **extra: Any) -> dict[str, Any]:
        ...
        print(f"\r{self.experiment_id} [{bar}] {processed}/{self.total} {payload['percent']:6.2f}% errors={errors}", end="", flush=True)
