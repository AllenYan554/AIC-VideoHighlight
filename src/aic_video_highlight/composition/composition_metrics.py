"""spatial composition composition behaviour metrics: visibility, shift, strata, overflow.
...
from aic_video_highlight.composition.subject_shifted_crop import SanitizedSubject
