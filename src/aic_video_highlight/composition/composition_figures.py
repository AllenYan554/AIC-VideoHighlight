"""spatial composition smoke visualization: geometry-true figures for audit categories.
...
from aic_video_highlight.runtime.io import atomic_write_json
...
def render_all_figures(
    ...
    payload = {
        "schema_version": "aic.vhicraft.composition-figure-index/v1",
